...
client = Client.create!(id: 1, client_name: 'Maye', number: '305-262-8080', img_url:'https://images.pexels.com/photos/428321/pexels-photo-428321.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', email: 'maye@hello.com', user_id: 1)
client = Client.create!(id: 2, client_name: 'Juan', number: '201-884-4500', img_url:'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', email: 'juan@hello.com', user_id: 1)
client = Client.create!(id: 3, client_name: 'Camilo', number: '305-100-6000', img_url:'https://images.pexels.com/photos/775358/pexels-photo-775358.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', email: 'camilo@hello.com', user_id: 1)
